...
Битрикс CModule*/
Class miet_vika extends CModule {
    /*Обязательные свойства объекта модуля*/
    const MODULE_ID = "miet.vika";
    var $MODULE_ID = "miet.vika";
    var $MODULE_VERSION;
    ...
    function __construct()
    {
        ...
        $this->MODULE_NAME = GetMessage("miet.vika_MODULE_NAME");
        $this->MODULE_DESCRIPTION =
            GetMessage("miet.vika_MODULE_DESC");
        $this->PARTNER_NAME = GetMessage("miet.vika_PARTNER_NAME");
        $this->PARTNER_URI = GetMessage("miet.vika_PARTNER_URI");
    }
   ...
   таблиц в БД для работы модуля*/
    ...
    {
        global $DB, $DBType;
        $DB->RunSQLBatch($_SERVER["DOCUMENT_ROOT"]."/local/modules/".self::MODULE_ID."/install/db/".strtolower($DBType)."/install.sql");return true;
    }
}